...
#include "../../DiscountCard/accountmanager.h"
...
QT_MOC_LITERAL(1, 15, 21), // "SAuthorizationSuccess"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 17), // "AuthorizedSuccess"
QT_MOC_LITERAL(4, 56, 4) // "flag"

    },
    "AccountManager\0SAuthorizationSuccess\0"
    "\0AuthorizedSuccess\0flag"
};
...
void AccountManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->AuthorizedSuccess((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (AccountManager::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AccountManager::SAuthorizationSuccess)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AccountManager::SAuthorizationSuccess(bool _t1)
{
