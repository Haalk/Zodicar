...
#include "../../DiscountCard/newclient.h"
...
struct qt_meta_stringdata_NewClient_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NewClient_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NewClient_t qt_meta_stringdata_NewClient = {
    {
QT_MOC_LITERAL(0, 0, 9) // "NewClient"
...
const QMetaObject NewClient::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewClient.data,
      qt_meta_data_NewClient,  qt_static_metacall, nullptr, nullptr}
};
...
void *NewClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NewClient.stringdata0))
