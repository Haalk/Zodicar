...
QT_MOC_LITERAL(1, 7, 9), // "SFinished"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 8), // "slotShow"
QT_MOC_LITERAL(4, 27, 4) // "show"

    },
    "Splash\0SFinished\0\0slotShow\0show"
};
...
void Splash::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotShow((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Splash::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Splash::SFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Splash::SFinished(bool _t1)
{
