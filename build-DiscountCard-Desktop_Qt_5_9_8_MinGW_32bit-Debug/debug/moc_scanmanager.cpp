...
#include "../../../DiscountCard fail/DiscountCard/scanmanager.h"
...
QT_MOC_LITERAL(1, 12, 15), // "SScanSuccessful"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4), // "what"
QT_MOC_LITERAL(4, 34, 5) // "value"

    },
    "ScanManager\0SScanSuccessful\0\0what\0"
    "value"
};
...
void ScanManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SScanSuccessful((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ScanManager::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScanManager::SScanSuccessful)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ScanManager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ScanManager.data,
...
// SIGNAL 0
void ScanManager::SScanSuccessful(const QString & _t1, const QString & _t2)
{
